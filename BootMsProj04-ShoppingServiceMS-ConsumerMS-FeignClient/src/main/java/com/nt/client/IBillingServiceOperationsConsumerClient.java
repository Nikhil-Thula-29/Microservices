...
@FeignClient("Billing-Service") //here this @Feignclient with service name and on top of main we have @EnableFeignClient also imp. This inteface creats in memory proxy class
